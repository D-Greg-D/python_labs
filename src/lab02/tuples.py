...
) -> str | type[ValueError] | type[TypeError]:
    """
...
test_cases = {}
test_cases["format_record"] = [
    ("Григорьев Денис Данилович", "BIVT-25-1", 5.0),
    ("Горький Владимир", "IKN-BIVT-0", 3.333),
    ("Сидоров Сидор Сидорович", "GN-5", 4.1),
    ("  щербакова  анна   станиславовна ", "FK-01", 6.0),
    ("Пупупушкин", "PK-00", 2.0),
    ("Михайлов Стас", "", 6.0),
    ("Колесников Денис", "LI-2", "5.0"),
]
